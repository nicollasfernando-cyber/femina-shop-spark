  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-6 py-16 max-w-3xl">
        ...
        <p className="text-muted-foreground mb-4">
          To start a return, contact us at support@femvitalhealth.online with your order number.
        </p>
        <p className="text-muted-foreground mb-4">
        ...
        <p className="text-muted-foreground mb-6">
          If you are not satisfied with your purchase, contact us at support@femvitalhealth.online. We want you to be happy with your order and will work to find a solution.
        </p>

        <h2 className="font-serif text-2xl font-semibold text-foreground mt-10 mb-4">DAMAGES AND DEFECTS</h2>
        <p className="text-muted-foreground mb-6">
          Please inspect your order upon delivery. If you receive a damaged, defective, or incorrect item, contact us immediately at support@femvitalhealth.online so we can resolve the issue.
        </p>
        ...
        <p className="text-muted-foreground mb-6">
          If more than 15 business days have passed since approval, contact us at support@femvitalhealth.online.
        </p>
