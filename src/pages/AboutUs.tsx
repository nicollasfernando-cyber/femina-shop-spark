  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-6 py-16 max-w-3xl">
        <h1 className="font-serif text-4xl font-bold text-foreground mb-8">About Velara Health</h1>

        <div className="text-muted-foreground space-y-6">
          <p>
            Velara Health is a wellness-focused brand dedicated to supporting women's health through thoughtfully formulated nutritional products designed for modern lifestyles.
          </p>
          <p>
          ...
          <p>
            Velara Health operates from our mailing office in New York and proudly serves customers across the United States through our online platform.
          </p>
        </div>
